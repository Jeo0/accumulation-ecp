...
{
    public partial class Fin_pos1 : Form
    {
        // GLOBAL VARIABLES
        double price1 = 0.0;
        double price2 = 0.0;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                namelbl1.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][2].ToString();
                namelbl2.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][3].ToString();
                namelbl3.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][4].ToString();
                namelbl4.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][5].ToString();
                namelbl5.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][6].ToString();
                namelbl6.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][7].ToString();
                namelbl7.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][8].ToString();
                namelbl8.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][9].ToString();
                namelbl9.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][10].ToString();
                namelbl10.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][11].ToString();
                namelbl11.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][12].ToString();
                namelbl12.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][13].ToString();
                namelbl13.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][14].ToString();
                namelbl14.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][15].ToString();
                namelbl15.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][16].ToString();
                namelbl16.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][17].ToString();
                namelbl17.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][18].ToString();
                namelbl18.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][19].ToString();
                namelbl19.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][20].ToString();
                namelbl20.Text = posdb_connect.pos_sql_dataset.Tables[0].Rows[0][21].ToString();
        ...
        private void enterBtn_Click(object sender, EventArgs e)
        {
            try
            {
                if (senior_discount_button.Checked == true)
                {
                    posdb_connect.pos_sql = "INSERT INTO salesTbl (product_name, " +
                        ...
                        "', '" + pricetextbox.Text + "', '" + senior_discount_button.Text +
                        "', '" + discounttxtbox.Text + "', '" + discountedtxtbox.Text + "', '" +
                        total_quantity_txtbox.Text + "', '" + total_discount_txtbox.Text + "', '" +
                        total_discounted_txtbox.Text + "', '" + terminal_noLbl.Text + "', '" +
                        time_dateLbl.Text + "', '" + emp_idLbl.Text + "')";
                    posdb_connect.pos_cmd();
                    posdb_connect.pos_sqladapterInsert();
                    cleartextboxes();
                }
                else if (with_discountCard_button.Checked == true)
                {
                    posdb_connect.pos_sql = "INSERT INTO salesTbl (product_name, " +
                        "product_quantity_per_transaction, product_price, discount_option, " +
                        "discount_amount_per_transaction, discounted_amount_per_transaction, " +
                        ...
                        "summary_total_discounted_amount, terminal_no, time_date, emp_id) " +
                        "VALUES ('" + itemnametxtbox.Text + "', '" + quantitytxtbox.Text +
                        "', '" + pricetextbox.Text + "', '" + with_discountCard_button.Text +
                        "', '" + discounttxtbox.Text + "', '" + discountedtxtbox.Text + "', '" +
                        total_quantity_txtbox.Text + "', '" + total_discount_txtbox.Text + "', '" +
                        total_discounted_txtbox.Text + "', '" + terminal_noLbl.Text + "', '" +
                        time_dateLbl.Text + "', '" + emp_idLbl.Text + "')";
                ...
                else if (employee_discount_button.Checked == true)
                {
                    posdb_connect.pos_sql = "INSERT INTO salesTbl (product_name, " +
                        "product_quantity_per_transaction, product_price, discount_option, " +
                        "discount_amount_per_transaction, discounted_amount_per_transaction, " +
                        ...
                        "summary_total_discounted_amount, terminal_no, time_date, emp_id) " +
                        "VALUES ('" + itemnametxtbox.Text + "', '" + quantitytxtbox.Text +
                        "', '" + pricetextbox.Text + "', '" + employee_discount_button.Text +
                        "', '" + discounttxtbox.Text + "', '" + discountedtxtbox.Text + "', '" +
                        total_quantity_txtbox.Text + "', '" + total_discount_txtbox.Text + "', '" +
                        total_discounted_txtbox.Text + "', '" + terminal_noLbl.Text + "', '" +
                        time_dateLbl.Text + "', '" + emp_idLbl.Text + "')";
                ...
                else if (no_discount_button.Checked == true)
                {
                    posdb_connect.pos_sql = "INSERT INTO salesTbl (product_name, " +
                        "product_quantity_per_transaction, product_price, discount_option, " +
                        "discount_amount_per_transaction, discounted_amount_per_transaction, " +
                        ...
                        "summary_total_discounted_amount, terminal_no, time_date, emp_id) " +
                        "VALUES ('" + itemnametxtbox.Text + "', '" + quantitytxtbox.Text +
                        "', '" + pricetextbox.Text + "', '" + no_discount_button.Text +
                        "', '" + discounttxtbox.Text + "', '" + discountedtxtbox.Text + "', '" +
                        total_quantity_txtbox.Text + "', '" + total_discount_txtbox.Text + "', '" +
                        total_discounted_txtbox.Text + "', '" + terminal_noLbl.Text + "', '" +
                        time_dateLbl.Text + "', '" + emp_idLbl.Text + "')";
